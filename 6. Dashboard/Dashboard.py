...
# Untuk mendukung hal ini, perlu mengurutkan DataFrame berdasarkan order_date serta memastikan kedua kolom tersebut bertipe datetime.
...
# Menggunakan widget date input sebagai filternya dan akan ditempatkan pada bagian sidebar. 
# Untuk alasan estetika, kita juga perlu menambahkan logo perusahaan ke dalam sidebar tersebut. 
...
# Demografi pelanggan, tiga buah visualisasi data.
